<?php use_helper('informacion','fechas','Javascript') ?>

<div class="capa_principal" id="ejercicios">
  <div class="titulo_principal">
      <h2 class="titbox">
               <?php echo link_to_function(
                                            ($alumno->getNombre().' '.$alumno->getApellidos()).'&nbsp;&nbsp; - &nbsp;&nbsp; '.$curso->getNombre(),
                                            //visual_effect('appear', 'ficha_'.$alumno->getId())
                                            "mostrar('ficha_".$alumno->getId()."')"
                                          ) ?>
      </h2>
  </div>
  <div id='ficha_<?echo $alumno->getId()?>' style='display:none'>
