...
sitems[0]=["1. Los grupos de interés", "javascript: pagecontent.showpage(0); refrescaSelect(1);"]
sitems[1]=["2. El modelo de gestión", "javascript: pagecontent.showpage(3); refrescaSelect(4);"]
sitems[2]=["3. El mercado y los stakeholders", "javascript: pagecontent.showpage(5); refrescaSelect(6);"]
sitems[3]=["4. Los stakeholders estratégicos", "javascript: pagecontent.showpage(7); refrescaSelect(8);"]
sitems[4]=["5. Las estrategias de RSC", "javascript: pagecontent.showpage(10); refrescaSelect(11);"]
