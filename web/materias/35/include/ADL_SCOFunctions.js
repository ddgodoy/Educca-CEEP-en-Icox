...
**                   user navigates between SCOs, or exits the Lesson, this file is based
**					 in the file SCOFunctions.js distributed by the ADL Technical Team.
**
** Design Issues:
**
...
{
   //computeTime(); //TODO there is a problem here produce an error
   exitPageStatus = true;
