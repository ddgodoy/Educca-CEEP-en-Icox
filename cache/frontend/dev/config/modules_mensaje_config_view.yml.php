...
if ($templateName.$this->viewName == 'verFicheroSuccess')
{
  ...
  $this->setComponentSlot('submenu', 'submenu', 'mensajeria');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "submenu" (submenu/mensajeria)');
