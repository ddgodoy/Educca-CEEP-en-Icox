...
if(oRestore.xml){var sCurId=oConfig.firstChild.getAttribute("publicId"),sCurTag=oConfig.firstChild.getAttribute("publishTag"),sRestTag=/\spublishTag=\"([^\"]+)\"/.test(oRestore.xml)&&RegExp.$1,sRestId=/\spublicId=\"([^\"]+)\"/.test(oRestore.xml)&&RegExp.$1
...
if(!bSilent&&oNavNode.tagName=="page"&&sSkip=="true"){oNavNode.setAttribute("visited",sSkip)
