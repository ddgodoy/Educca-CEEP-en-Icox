<?php
 ...
 class cursoComponents extends sfComponents
  ...
  // Nombre del m�todo: ListaCursosAlumno()
  // A�adida por: Jacobo Chaquet
  /* Descripci�n: Devuelve los paquetes en los que esta matriculado un alumno, y los cursos que esta matriculado qno pertenezcan a un paquete
  */
  ...
  // A�adida por: Jacobo Chaquet
  /* Descripci�n: Muestra la informacion de un curso
   */
