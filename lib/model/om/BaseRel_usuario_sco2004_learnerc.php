...
abstract class BaseRel_usuario_sco2004_learnerc extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Rel_usuario_sco2004_learnercPeer::ID;
		}
	...
	public function setIdSco2004($v)
	{
		...
		if ($this->id_sco2004 !== $v) {
			$this->id_sco2004 = $v;
			$this->modifiedColumns[] = Rel_usuario_sco2004_learnercPeer::ID_SCO2004;
		}
	...
	public function setIdUsuario($v)
	{
		...
		if ($this->id_usuario !== $v) {
			$this->id_usuario = $v;
			$this->modifiedColumns[] = Rel_usuario_sco2004_learnercPeer::ID_USUARIO;
		}
	...
	public function setCommentIndex($v)
	{
		...
		if ($this->comment_index !== $v) {
			...
			$this->modifiedColumns[] = Rel_usuario_sco2004_learnercPeer::COMMENT_INDEX;
		}
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = Rel_usuario_sco2004_learnercPeer::COMMENT;
		}
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = Rel_usuario_sco2004_learnercPeer::LOCATION;
		}
	...
	public function setTstamp($v)
	{
		...
		if ($this->tstamp !== $ts) {
			$this->tstamp = $ts;
			$this->modifiedColumns[] = Rel_usuario_sco2004_learnercPeer::TSTAMP;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Rel_usuario_sco2004_learnerc object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Rel_usuario_sco2004_learnercPeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aUsuario !== null) {
				...
				$this->setUsuario($this->aUsuario);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Rel_usuario_sco2004_learnercPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Rel_usuario_sco2004_learnercPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Rel_usuario_sco2004_learnercPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Rel_usuario_sco2004_learnercPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Rel_usuario_sco2004_learnercPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Rel_usuario_sco2004_learnercPeer::ID)) $criteria->add(Rel_usuario_sco2004_learnercPeer::ID, $this->id);
		if ($this->isColumnModified(Rel_usuario_sco2004_learnercPeer::ID_SCO2004)) $criteria->add(Rel_usuario_sco2004_learnercPeer::ID_SCO2004, $this->id_sco2004);
		if ($this->isColumnModified(Rel_usuario_sco2004_learnercPeer::ID_USUARIO)) $criteria->add(Rel_usuario_sco2004_learnercPeer::ID_USUARIO, $this->id_usuario);
		if ($this->isColumnModified(Rel_usuario_sco2004_learnercPeer::COMMENT_INDEX)) $criteria->add(Rel_usuario_sco2004_learnercPeer::COMMENT_INDEX, $this->comment_index);
		if ($this->isColumnModified(Rel_usuario_sco2004_learnercPeer::COMMENT)) $criteria->add(Rel_usuario_sco2004_learnercPeer::COMMENT, $this->comment);
		if ($this->isColumnModified(Rel_usuario_sco2004_learnercPeer::LOCATION)) $criteria->add(Rel_usuario_sco2004_learnercPeer::LOCATION, $this->location);
		if ($this->isColumnModified(Rel_usuario_sco2004_learnercPeer::TSTAMP)) $criteria->add(Rel_usuario_sco2004_learnercPeer::TSTAMP, $this->tstamp);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Rel_usuario_sco2004_learnercPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new Rel_usuario_sco2004_learnercPeer();
		}
		return self::$peer;
	}
