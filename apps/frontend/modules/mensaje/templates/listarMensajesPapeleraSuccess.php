...
<div class="listado_tabla_general">
  <table class="tablamensajes" cellspacing="0">
    ...
    <?php foreach($mensajes as $mensaje): ?>
      ...
      <tr<?php echo ($mensaje->getLeido())? " class=\"leido\"":" class=\"noleido\""; echo $fondo;?>>
        ...
        <td class="td4"><?php echo link_to(truncate_text($mensaje->getAsunto_mensaje()->getDescripcion(), 30), 'mensaje/mostrarMensajeRecibido?id_mensaje='.$mensaje->getId()) ?></td>
  ...
  <?php if (!$i):?>
    <?php echoAvisoVacio("La carpeta de mensajes borrados est&aacute; vac&iacute;a");?>
  <?php endif; ?>
