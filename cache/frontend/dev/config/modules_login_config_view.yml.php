...
if ($templateName.$this->viewName == 'verFicheroSuccess')
{
  ...
  $this->setComponentSlot('menu', 'menu', 'default');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu" (menu/default)');
  $this->setComponentSlot('menu_top', 'menu_top', 'default');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu_top" (menu_top/default)');
