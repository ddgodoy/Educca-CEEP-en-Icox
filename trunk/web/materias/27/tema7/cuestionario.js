...
resp=new Array("Favorecer una formación permanente que asegure su cualificación, crecimiento intelectual y sobre todo su -empleabilidad-.","Procurar la distribución equitativa de la riqueza generada.","Servir a la sociedad con productos útiles y en condiciones justas.","Respetar el medio ambiente.","Ayudas a planes personales de pensiones.")
...
"Question 1",
0,
"¿Cuál delas siguientes es una responsabilidad secundaria de la empresa de RSC?:",
resp,
comm,
corr,
"",
...
resp=new Array("Mejorar las relaciones con los stakeholders de los medios de comunicación y de la comunidad en general.","En desarrollar las responsabilidades inherentes a la actividad específica de la empresa.","Mejorar los efectos resultantes de esa misma actividad específica en los grupos sociales interdependientes con la empresa.","En actuaciones de la empresa encaminadas a mejorar determinados aspectos de su entorno social más allá de su actividad específica.","Ninguna es correcta.")
...
"Question 3",
0,
"Esta responsabilidad de qué tipo es: Promover y facilitar su participación en programas de ayuda a la comunidad o al tercer mundo:",
resp,
comm,
corr,
"",
...
"Question 4",
0,
"A qué tipo de responsabilidad responde este principio de actuación de RC: Promover y facilitar su participación en programas de ayuda a la comunidad o al tercer mundo:",
resp,
comm,
corr,
"",
...
"Question 5",
0,
"¿La clasificación de las responsabilidades a que grupos de prevalencia atiende?:",
resp,
comm,
corr,
"",
...
resp=new Array("Una profunda reflexión sobre la empresa.","Requiere de entrada un planteamiento de desarrollo por etapas.","Del establecimiento de perspectivas inmediatas de desarrollo.","De establecer los ideales a los que aspira.","De una etapa inicial de descubrir debilidades y fortalezas.")
corr=new Array("0","1","0","0","0")
comm=""
valu=""
...
"Question 6",
0,
"El desarrollo de un Plan de Acción precisa de...",
resp,
comm,
corr,
"",
...
resp=new Array("La dirección empresarial.","Los sindicatos.","Los stakeholder externos.","La legislación de desarrollo sostenible.","El director de RR.HH.")
corr=new Array("1","0","0","0","0")
comm=""
valu=""
...
"Question 7",
0,
"¿Quién inicia un Plan de Acción Social empresarial?:",
resp,
comm,
corr,
"",
...
resp=new Array("Conocer las necesidades y oportunidades de las empresas.","Establecer unos criterios de maximalización de benéficos empresariales teniendo en cuenta los requisitos de las normas.","Comprender las necesidades de los directivos y accionistas de las empresas.","Implementación de los DAFOS en los planes estratégicos.","Instaurar una planificación de negocio acorde con los requerimientos de los stakeholders internos.")
corr=new Array("1","0","0","0","0")
comm=""
valu=""
...
"Question 8",
0,
"La clasificación de responsabilidades sociales atiende a un criterio básico de...",
resp,
comm,
corr,
"",
...
resp=new Array("Con el estudio de los impactos sociales de la actividad.","Con los programas de RSC de empresas de interés.","Con la valuación de demandas sociales y consideración de efectos en los grupos interesados.","El análisis de la acción social histórica.","Participar en proyectos de desarrollo local y regional.")
...
"Question 9",
0,
"Alguna de estas afirmaciones no es correcta con el análisis de la situación inicial de un Plan de Acción de RSC ¿cuál es?:",
resp,
comm,
corr,
"",
...
resp=new Array("Atender las necesidades de los stakeholders internos de la empresa.","A las necesidades de los accionistas y directivos.","Inherentes a la actividad productiva de la empresa.","Comporta establecer lazos con la Administración Pública y las organizaciones internacionales.","Cooperar con los proveedores y distribuidores para obtener benéficos empresariales.")
corr=new Array("0","0","1","0","0")
comm=""
valu=""
