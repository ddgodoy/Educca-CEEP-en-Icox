...
function abrirCuestionario() {	
	child = open ("cuestionario.html",'child','left=20,top=20,width=760,height=620,scrollbars=1,status=1,resizable=1');
	StartTime = new Date().getTime();
}
...
function mm_adlOnload()
{
  ...
  contenido += mm_nombre;
  contenido += '</p>\n'+'</td>\n'+'</tr>\n'+'<tr>\n'+'<td>&nbsp;</td>\n'+'<td height="20"><img src="../shared/imagenes/biblio_p.jpg" alt="tema" width="20" height="25" hspace="2" align="absmiddle" />Te encuentras en la unidad de <strong>Los Antecedentes Hist&oacute;ricos</strong></td>\n'+'</tr>\n'+'<tr>\n'+'<td>&nbsp;</td>\n'+'<td height="20"><img src="../shared/imagenes/lupa.jpg" alt="revisión" width="20" height="25" hspace="2" align="absmiddle" />Has revisado este tema <strong>';
