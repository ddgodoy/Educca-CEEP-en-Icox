...
<div id="mistemas">
  <div class="tit_box_mensajes"><h2 class="titbox"><?php echo $curso->getNombre()?> - Biblioteca de archivos</h2></div>
        ...
        <?php if(!$usuario->getInspector()): ?>
            <div class="herramientas_general">
              <table style="width: 100%;">
                <tr>
                  <td>
                    <input class="boton_gris_herramientas1" style="width:100px;" onclick="window.location='<?php echo url_for('biblioteca_archivos/nuevo?idcurso='.$curso->getId())?>'"  name="add" value="Subir fichero" type="button">
                  </td>
                  <td></td>
                </tr>
              </table>
