        ...
        <tr>
            ...
            <?php if ($busqueda):?>
              <td style="width:135px;">
                <?php echo sexy_button_to('Nueva b&uacute;squeda', 'admin/buscar?rol=alumno') ?>
              </td>
              <td>
                <?php echo sexy_button_to('Ver todos los alumnos', 'admin/alumnos') ?>
              </td>
            <?php else:?>
              <td>
                <?php echo sexy_button_to('Buscar', 'admin/buscar?rol=alumno') ?>
              </td>
            <?php endif; ?>
        </tr>
        </table>
