      ...
      <table cellspacing="0" cellpadding="0">
        <tr>
          <td>
            ...
            <?php else:?>
              <?php echo sexy_button_to('Buscar alumnos de este m&oacute;dulo', 'supervisor/buscar?rol=alumno&id_modulo='.$idmodulo) ?>
            <?php endif;?>
          </td>
        </tr>
      </table>
                  ...
                  <?php foreach($alumnos as $alumno): ?>
                      ...
                      <tr class="cont_fil" <?= $fondo1 ?>>
                          ...
                          <td class="td3" style="text-align: center;">
                            <?php echo link_to(image_tag('ico_cursos_peq.gif',"Alt=\"Ver cursos del alumno ".$alumno->getNombre()."\" Title=\"Ver cursos del alumno ".$alumno->getNombre()."\" align=absmiddle"), 'supervisor/listarCursosAlumno?idusuario='.$alumno->getId()); ?>
                            &nbsp;&nbsp;&nbsp;<?php echo link_to(image_tag('ico_modulos_peq.gif', array('alt' => 'Ver los m&oacute;dulos de '.$alumno->getNombre(), 'title' => 'Ver los m&oacute;dulos de '.$alumno->getNombre(), 'align' => 'absmiddle')), 'supervisor/listaModulos?idusuario='.$alumno->getId().'&rol=alumno', array('class' => 'a_explicito')) ?>
                          </td>
                      </tr>
                      <?php $i++ ?>
                  <?php endforeach; ?>
      ...
      <table>
        <tr>
          ...
          <td style="padding-left: 15px;">
            <?php echo image_tag('ico_modulos_peq.gif',"Alt=\"Ver m&oacute;dulos del alumno\" Title=\"Ver m&oacute;dulos del alumno\" align=absmiddle"); ?>
          </td>
          <td>
