 ...
 * @package    edoceo
 * @subpackage curso
 * @author     Jacobo Chaquet y Santiago Martínez de la Riva
...
class cursoActions extends sfActions
{
 ...
 public function validateDarAlta()
  ...
  // Nombre del método: altaPaquete($idpaquete)
  // Añadida por: Jacobo Chaquet
  /* Descripción: - metodo privado invocado desde executeDarAlta()
   ...
   */
	...
	private function altaPaquete($idpaquete)
	{
	  ...
	  // Nombre del método: altaCurso($idcurso)
	  // Añadida por: Jacobo Chaquet
	  /* Descripción: - metodo privado invocado desde executeDarAlta() o altaPaquete
	                  - da de alta a un usuario como alumno (tabla rel_usuario_rol_curso)
	                  - comprueba que el usuario no estubiera dado de alta ya en el curso
	...
	private function altaCurso($idcurso)
	{
	  ...
	  // Nombre del método: executeDarAlta()
	  // Añadida por: Jacobo Chaquet
	  /* Descripción: Viene de Ajax, recibe un form con una serie checkbox con el ID del curso
	...
	public function executeDarAlta()
	{
	  ...
	  // Nombre del método: executeInfoPaquete()
	  // Añadida por: Jacobo Chaquet
	  /* Descripción: Muestrara la informacion de un paquete, se usa a la hora de matricularse
	   */
	...
	{    $esAjax = $this->getRequest()->isXmlHttpRequest();
	  ...
	  // Nombre del método: executeInfoCurso()
	  // Añadida por: Jacobo Chaquet
	  /* Descripción: Muestrara la informacion de un curso, se usa a la hora de matricularse
	   */
	...
	{    $esAjax = $this->getRequest()->isXmlHttpRequest();
	  ...
	  // Nombre del método: executeCerrar()
	  // Añadida por: Jacobo Chaquet
	  /* Descripción: Sirve para cerrar las capas ajax
	   */
    ...
    private function traducir_de_fecha_scorm12 ($string)
    {
	 ...
	 // Nombre del método: executeMostrarTemas()
	  // Añadida por: Todor Blajev
	  /* Descripción: Acción para mostrar los temas correspondientes a la materia de un curso
	   */
	...
	public function executeMostrarBibliografia()
  {
   ...
   // Nombre del método: NuevoLibro()
  // Añadida por: Santiago Martínez de la Riva
  // Modificada por: Jacobo Chaquet. Pasa hacer 2 acciones nuevoLibro y guardarLibro
  /* Descripción: Genera la plantilla del nuevo libro
  				  Puede recibir parametros:
					  - idcurso y idalumno: si los recibe en su template no apareceran los select de estos // Nombre del método: GuardarLibro()
                      - Guarda un nuevo libro, que será mostrado en la Bibliografía tanto de
  ...
  {  $this->idcurso = $this->getRequestParameter('idcurso');
     ...
     if ($this->getRequest()->getMethod() == sfRequest::POST)
     {
      ...
      // Nombre del método: executeEliminarLibro()
	  // Añadida por: Jacobo Chaquet
	  /* Descripción: Elimina un libro de la bibliografia
	   */
  public function executeEliminarLibro() {
   ...
   // Nombre del método: executeModificarLibro()
   // Añadida por: Jacobo Chaquet
  /* Descripción: Modifica un libro de la bibliografia.
   */
  ...
  public function executeModificarLibro()
  {
    ...
    // Nombre del método: executeMostrarBibliografia()
	  // Añadida por: Todor Todorov Blajev
	  /* Descripción: Acción que saca la información y normativa de un curso.
	   */
  ...
  // Nombre del método: executeMostrarContenido()
  // Añadida por: Ángel Martín Latasa
  /* Descripción: Muestra el contenido de un curso SCORM
  */
