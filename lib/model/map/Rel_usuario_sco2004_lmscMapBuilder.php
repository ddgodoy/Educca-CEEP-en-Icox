...
class Rel_usuario_sco2004_lmscMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Rel_usuario_sco2004_lmscMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('rel_usuario_sco2004_lmsc');
		$tMap->setPhpName('Rel_usuario_sco2004_lmsc');
