...
sitems[0]=["1. Alcance en las instituciones", "javascript: pagecontent.showpage(0); refrescaSelect(1);"]
sitems[1]=["2. Comisión de las Comunidades Europeas", "javascript: pagecontent.showpage(1); refrescaSelect(2);"]
sitems[2]=["3. Organización de las Naciones Unidas", "javascript: pagecontent.showpage(7); refrescaSelect(8);"]
sitems[3]=["4. Global Reporting Initiative", "javascript: pagecontent.showpage(12); refrescaSelect(13);"]
sitems[4]=["5. OCDE", "javascript: pagecontent.showpage(14); refrescaSelect(15);"]
sitems[5]=["6. WBCD", "javascript: pagecontent.showpage(15); refrescaSelect(16);"]
sitems[6]=["7. Matriz de CSR Europe", "javascript: pagecontent.showpage(17); refrescaSelect(18);"]
sitems[7]=["8. Foro Europeo Multistakeholder", "javascript: pagecontent.showpage(20); refrescaSelect(21);"]
