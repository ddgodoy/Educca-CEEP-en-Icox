...
class contenidosTemaActions extends sfActions
{
  ...
  // Nombre del m�todo: executeControlTiempo()
  // A�adida por: Jacobo Chaquet
  /* Descripci�n: Controla el tiempo que un usuario esta en un tema, funciona mediante ajax
   */
  ...
  // Nombre del m�todo: executeInitialize()
  // A�adida por: Jacobo Chaquet
  /* Descripci�n: Cuando un usuario se introduce en ese tema por primera vez guardamos la fecha
   */
  ...
  // Nombre del m�todo: executeFinish()
  // A�adida por: Jacobo Chaquet
  /* Descripci�n: Cuando un usuario finaliza tema guardamos la fecha
   */
