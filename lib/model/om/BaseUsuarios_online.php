...
abstract class BaseUsuarios_online extends BaseObject  implements Persistent {
	...
	public function setIdUsuario($v)
	{
		...
		if ($this->id_usuario !== $v) {
			$this->id_usuario = $v;
			$this->modifiedColumns[] = Usuarios_onlinePeer::ID_USUARIO;
		}
	...
	public function setIdCurso($v)
	{
		...
		if ($this->id_curso !== $v) {
			$this->id_curso = $v;
			$this->modifiedColumns[] = Usuarios_onlinePeer::ID_CURSO;
		}
	...
	public function setIdRol($v)
	{
		...
		if ($this->id_rol !== $v) {
			$this->id_rol = $v;
			$this->modifiedColumns[] = Usuarios_onlinePeer::ID_ROL;
		}
	...
	public function setTiempo($v)
	{
		...
		if ($this->tiempo !== $v) {
			$this->tiempo = $v;
			$this->modifiedColumns[] = Usuarios_onlinePeer::TIEMPO;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Usuarios_online object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Usuarios_onlinePeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aRol !== null) {
				...
				$this->setRol($this->aRol);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Usuarios_onlinePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Usuarios_onlinePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Usuarios_onlinePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Usuarios_onlinePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Usuarios_onlinePeer::getFieldNames($keyType);
		$result = array(
	...
	{
		$criteria = new Criteria(Usuarios_onlinePeer::DATABASE_NAME);

		if ($this->isColumnModified(Usuarios_onlinePeer::ID_USUARIO)) $criteria->add(Usuarios_onlinePeer::ID_USUARIO, $this->id_usuario);
		if ($this->isColumnModified(Usuarios_onlinePeer::ID_CURSO)) $criteria->add(Usuarios_onlinePeer::ID_CURSO, $this->id_curso);
		if ($this->isColumnModified(Usuarios_onlinePeer::ID_ROL)) $criteria->add(Usuarios_onlinePeer::ID_ROL, $this->id_rol);
		if ($this->isColumnModified(Usuarios_onlinePeer::TIEMPO)) $criteria->add(Usuarios_onlinePeer::TIEMPO, $this->tiempo);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Usuarios_onlinePeer::ID_USUARIO, $this->id_usuario);
		$criteria->add(Usuarios_onlinePeer::ID_CURSO, $this->id_curso);
	...
	{
		if (self::$peer === null) {
			self::$peer = new Usuarios_onlinePeer();
		}
		return self::$peer;
	}
