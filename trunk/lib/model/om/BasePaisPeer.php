...
abstract class BasePaisPeer {
	...
	const ISONUM = 'pais.ISONUM';

	
	const ISO2 = 'pais.ISO2';

	
	const ISO3 = 'pais.ISO3';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Isonum', 'Iso2', 'Iso3', 'Nombre', ),
		BasePeer::TYPE_COLNAME => array (PaisPeer::ID, PaisPeer::ISONUM, PaisPeer::ISO2, PaisPeer::ISO3, PaisPeer::NOMBRE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'isonum', 'iso2', 'iso3', 'nombre', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Isonum' => 1, 'Iso2' => 2, 'Iso3' => 3, 'Nombre' => 4, ),
		BasePeer::TYPE_COLNAME => array (PaisPeer::ID => 0, PaisPeer::ISONUM => 1, PaisPeer::ISO2 => 2, PaisPeer::ISO3 => 3, PaisPeer::NOMBRE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'isonum' => 1, 'iso2' => 2, 'iso3' => 3, 'nombre' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PaisPeer::ISONUM);

		$criteria->addSelectColumn(PaisPeer::ISO2);

		$criteria->addSelectColumn(PaisPeer::ISO3);
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$rs = PaisPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	public static function doSelectOne(Criteria $criteria, $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = PaisPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	public static function doValidate(Pais $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(PaisPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(PaisPeer::TABLE_NAME);
		...
		$res =  BasePeer::doValidate(PaisPeer::DATABASE_NAME, PaisPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = PaisPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(PaisPeer::ID, $pk);


		$v = PaisPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(PaisPeer::ID, $pks, Criteria::IN);
			$objs = PaisPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
