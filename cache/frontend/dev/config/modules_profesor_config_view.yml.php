...
if ($templateName.$this->viewName == 'verFicheroSuccess')
{
  ...
  $this->setComponentSlot('menu', 'menu', 'profesor');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu" (menu/profesor)');
  $this->setComponentSlot('menu_top', 'menu_top', 'profesor');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu_top" (menu_top/profesor)');
