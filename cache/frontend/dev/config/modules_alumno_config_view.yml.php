...
if ($templateName.$this->viewName == 'verFicheroSuccess')
{
  ...
  $this->setComponentSlot('menu', 'menu', 'alumno');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu" (menu/alumno)');
  $this->setComponentSlot('menu_top', 'menu_top', 'alumno');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu_top" (menu_top/alumno)');
