...
sitems[0]=["1. La empresa y el medio ambiente", "javascript: pagecontent.showpage(0); refrescaSelect(1);"]
sitems[1]=["2. La actitud de las empresas", "javascript: pagecontent.showpage(6); refrescaSelect(7);"]
sitems[2]=["3. Buenas prácticas medioambientales", "javascript: pagecontent.showpage(10); refrescaSelect(11);"]
sitems[3]=["4. Herramientas previas ambientales", "javascript: pagecontent.showpage(12); refrescaSelect(13);"]
sitems[4]=["5. Formulación estratégica", "javascript: pagecontent.showpage(14); refrescaSelect(15);"]
sitems[5]=["6. El desarrollo sostenible", "javascript: pagecontent.showpage(15); refrescaSelect(16);"]
sitems[6]=["7. Sistema de gestión medioambiental", "javascript: pagecontent.showpage(17); refrescaSelect(18);"]
sitems[7]=["8. Las normas de gestión medioambiental", "javascript: pagecontent.showpage(21); refrescaSelect(22);"]
sitems[8]=["9. Auditorías medioambientales", "javascript: pagecontent.showpage(24); refrescaSelect(25);"]
