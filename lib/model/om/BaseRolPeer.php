...
abstract class BaseRolPeer {
	...
	const CREATED_AT = 'rol.CREATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (RolPeer::ID, RolPeer::NOMBRE, RolPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'created_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'CreatedAt' => 2, ),
		BasePeer::TYPE_COLNAME => array (RolPeer::ID => 0, RolPeer::NOMBRE => 1, RolPeer::CREATED_AT => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'created_at' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RolPeer::ID);

		$criteria->addSelectColumn(RolPeer::NOMBRE);

		$criteria->addSelectColumn(RolPeer::CREATED_AT);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(RolPeer::ID, $pks, Criteria::IN);
