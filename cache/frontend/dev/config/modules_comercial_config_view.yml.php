...
else if ($this->actionName.$this->viewName == 'sf_captcha')
{
  $templateName = $response->getParameter($this->moduleName.'_'.$this->actionName.'_template', $this->actionName, 'symfony/action/view');
  $this->setTemplate($templateName.$this->viewName.$this->getExtension());
}
else if ($this->actionName.$this->viewName == 'confirmacionSuccess')
{
  $templateName = $response->getParameter($this->moduleName.'_'.$this->actionName.'_template', $this->actionName, 'symfony/action/view');
  $this->setTemplate($templateName.$this->viewName.$this->getExtension());
}
...
else if ($templateName.$this->viewName == 'sf_captcha')
{
  $this->setComponentSlot('menu', 'menu', 'variable');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu" (menu/variable)');
  $this->setComponentSlot('menu_top', 'menu_top', 'variable');
...
else if ($templateName.$this->viewName == 'confirmacionSuccess')
{
  $this->setComponentSlot('menu', 'menu', 'variable');
  if (sfConfig::get('sf_logging_enabled')) $context->getLogger()->info('{sfViewConfig} set component "menu" (menu/variable)');
  $this->setComponentSlot('menu_top', 'menu_top', 'variable');
