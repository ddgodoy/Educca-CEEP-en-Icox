...
if((bExit&&oLastPage&&!getNavNode(oLastPage,"next")&&!oTestNode.selectSingleNode(".//page[not(@visited)]"))||(oNewResource&&oNewResource.parentNode.tagName!="section"&&oNewResource.parentNode.tagName!="test")){evaluateTest(oTestNode)}}
