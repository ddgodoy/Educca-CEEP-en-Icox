...
sitems[0]=["1. El compromiso", "javascript: pagecontent.showpage(0); refrescaSelect(1);"]
sitems[1]=["2. La política empresarial", "javascript: pagecontent.showpage(3); refrescaSelect(4);"]
sitems[2]=["3. El compromiso con la sociedad", "javascript: pagecontent.showpage(6); refrescaSelect(7);"]
sitems[3]=["4. Diagnóstico y planificaión", "javascript: pagecontent.showpage(7); refrescaSelect(8);"]
sitems[4]=["5. La implantación", "javascript: pagecontent.showpage(9); refrescaSelect(10);"]
sitems[5]=["6. Verificación de objetivos y resultados", "javascript: pagecontent.showpage(19); refrescaSelect(20);"]
sitems[6]=["7. Revisión y mejora del sistema de RSC", "javascript: pagecontent.showpage(24); refrescaSelect(25);"]
