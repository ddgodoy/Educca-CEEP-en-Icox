...
class Usuario extends BaseUsuario
{
  ...
  // Nombre del método: getTotalAlumnos()
  // Añadida por: Jacobo Chaquet
  /* Descripción: Devuelve el numero de alumnos totales que hay en la base de datos
   */
 ...
 */
 ...
 public function getAlumnos($curso =  null, $crit = null, $morosos=true)
  {
    $c = new Criteria();
    $c->add(RolPeer::NOMBRE, "alumno");
    $rol = RolPeer::doSelectOne($c);
...
/**
 *
 * @name        getAlumnosActivos()
 * @access      public
 * @author      Jacobo Chaquet
 * @deprecated  devuelve todos alumnos activos a fecha de hoy
 *              Alumno activo = esta matriculado en cursos qse imparten a fecha de hoy
 */
 ...
 public function getAlumnosActivos()
  {
    $fecha = date('Y-m-d');
    $c = new Criteria();
    $c->add(CursoPeer::FECHA_INICIO,$fecha,Criteria::LESS_EQUAL);
    $c->add(CursoPeer::FECHA_FIN,$fecha,Criteria::GREATER_EQUAL);
    $c->addJoin(CursoPeer::ID, Rel_usuario_rol_cursoPeer::ID_CURSO);
    $c->add(RolPeer::NOMBRE, "alumno");
...
/**
 *
 * @name        getCursosActivos()
 * @access      public
 * @author      Jacobo Chaquet
 * @deprecated  devuelve los cursos activos a fecha de hoy
 */
 ...
 */
 ...
 public function getHitoTema($idTema)
  ...
  // Nombre del método: getSolucionEjercicio()
  // Añadida por: Ángel Martín
  /* Descripción: - devuelve la solucion que hizo el alumno del ejercicio con
   * identificador $id_ejercicio si llegó a resolver dicho ejercicio
   */
 ...
 */
 public function imparte($idcurso,$idtema)
  ...
  // Nombre del método: contarTests($id_curso)
  // Añadida por: Ángel Martín Latasa
  // Descripción: Cuenta el número de ejercicios de test que ha realizado un alumno en un curso
 ...
 */
  ...
  public function generarPassword()
  {
    ...
    $no_validos = array("á", "é", "í", "ó", "ú", "Á", "É", "Í", "Ó", "Ú","ñ","Ñ","ü","Ü","Ç","ç");
 ...
 */
  ...
  public function alta($parametros,$online=null) {
      ...
      $con = Propel::getConnection();
  		...
  		try	{
           ...
           // Lo damos de alta en el curso o módulo que corresponda
  ...
  /* Modificado por Jacobo Chaquet añadido parametro $datos para el tipo ranking, le pasamos el
     ranking ya en formato HTML a sí no hay que volverlo a calcular para cada alumno
  */
 ...
 */
  ...
  */
  ...
  public function getNumeroEjerciciosCurso ($id_curso)
  {
    $c = new Criteria();
    $c->add(Ejercicio_resueltoPeer::ID_AUTOR, $this->id);
    $c->add(Ejercicio_resueltoPeer::ID_CURSO, $id_curso);
  ...
  */
  public function nuevoInvitado()
  {
     ...
     // Fase 2, resetear el usuario más antiguo (el de "ultimoacceso" anterior)
     $s = sfContext::getInstance();
