...
resp=new Array("Un residuo.","Emisión atmosférica.","Un impacto medioambiental.","Un consumo no renovable.","Una contaminación de un medio hídrico.")
...
"Question 1",
0,
"¿La contaminación atmosférica qué es?:",
resp,
comm,
corr,
"",
...
resp=new Array("Reducción en los consumos de energía.","Reducción en el  uso de agua.","Reducción de las materias primas.","La motivación de las plantillas.","Reducción delos costes de tratamiento de residuos.")
...
"Question 2",
0,
"Dentro de las ventajas potenciales indirectas que como consecuencia de la introducción de Mejoras Medioambientales pueden obtener las empresas se encuentra:",
resp,
comm,
corr,
"",
...
resp=new Array("Los mercados competitivos.","La eco-eficiencia.","La evaluación de los procesos productivos.","A la evaluación del rendimiento y desempeño de funciones productivas.","Ninguna es correcta.")
corr=new Array("0","1","0","0","0")
comm=""
valu=""
...
resp=new Array("Es el proceso empresarial que atiende las necesidades de las generaciones actuales sin hipotecar el desarrollo de generaciones futuras.","Es el empleo de herramientas que proporcionan seguridad, confianza y credibilidad en la gestión de las empresas.","Es una declaración pública y formal por parte de la alta Dirección de una empresa.","Es el desarrollo  de unas políticas de prevención de riesgos laborales, calidad y cualquier otra política establecida en la organización.","Es una política conocida, comprendida, desarrollada y mantenida al día por todos los niveles de la organización.")
...
resp=new Array("La estrategia de las contingencias.","Estrategia en función de la legislación.","Estrategia de negocio competitivo y de beneficios.","Estrategia de conflicto.","La estrategia de consenso.")
corr=new Array("1","0","0","0","0")
comm=""
valu=""
...
"Question 5",
0,
"La estrategia medioambiental dependerá de la situación específica de la empresa, que habrá de determinarse en función del análisis interno y externo, de su tamaño organizativo, de su relación con los diferentes stakeholders, por lo que las medidas medioambientales que se adopten estarán en relación a los procesos productivos y los productos y el entorno o contexto. ¿A qué tipo de estrategia se refiere?:",
resp,
comm,
corr,
"",
...
resp=new Array("Etiqueta ecológica.","Desde el análisis de ciclo de vida.","Desde las instituciones públicas y los órganos de consumo humano.","Los costes asociados a su reparación.","Desde los costes asociados a su distribución y traslado para ver si compensa su deterioro.")
corr=new Array("0","1","0","0","0")
comm=""
valu=""
...
"Question 7",
0,
"Cuando se afirma que un producto contamina en el transporte y en su distribución es preciso contemplarlo desde...",
resp,
comm,
corr,
"",
...
resp=new Array("Costes de producción no compensatorios en la cuenta de resultados.","De oportunidades y de rentabilidad.","De costes asociados a nuevas maquinas y herramientas de producción ambiental.","De incesante trabajo de control estadístico en procesos de calidad.","Ninguna es correcta.")
corr=new Array("0","1","0","0","0")
comm=""
valu=""
...
"Question 8",
0,
"El factor medioambiental supone una serie de retos y amenazas para las empresas, pero también una fuente...",
resp,
comm,
corr,
"",
...
resp=new Array("El principio de control y de prevención.","El principio de gestión y de seguimiento.","El principio de no alterar y de pegar.","El principio de oportunidad de negocio y el principio de no contaminar.","El principio de prevención y de oportunidad de negocio.")
corr=new Array("1","0","0","0","0")
comm=""
valu=""
...
"Question 9",
0,
"Los sistemas de gestión medioambiental llevan implícitos dos principios que inspiran la política actual de protección integral del medio ambiente, ¿cuáles son estos dos principios?:",
resp,
comm,
corr,
"",
...
resp=new Array("Presiones internas.","Presiones externas.","Presiones mixtas.","Presiones jurídicas.","Presiones legislativas.")
corr=new Array("0","1","0","0","0")
comm=""
valu=""
...
"Question 10",
0,
"Dentro de las presiones que  soportan las empresas por el medio ambiente ¿cómo sería la de los grupos de presión?:",
resp,
comm,
corr,
"",
...
cachewrite("<h3><b>Resultados del Cuestionario Tema 8:  La gestión ambiental y  RSC.</b></h3><br><br>\n",0);
