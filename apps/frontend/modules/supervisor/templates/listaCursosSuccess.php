...
<div id="divadmin">
  ...
  <div class="cont_box_correo">
    ...
    <div class="nombrescol">
           <table>
		   <tr>
		   <td>      <?php echo $rol?>: <?php echo link_to($usuario->getNombre()." ".$usuario->getApellidos(), 'usuario/mostrarPerfil?idusuario='.$usuario->getId()) ?><br>
			     </td>
			  </tr>
            </table>
            <br><br>
   ...
   <?php echoNotaInformativa('Ayuda', 'Desde este panel podr&aacute; acceder a la informci&oacute;n de los cursos matriculados por el alumno')?>
