...
//  de códigos de error se pueden ver en las funciones getErrorString y
//  getDiagnostic
...
//  Nombre del método: Initialize (parameter)
//  Descripción:
    ...
    API_1484_11.Initialize = function(parameter) 
    {
      ...
      if (this.debug) {alert("LLAMADA Initialize()"); API_1484_11.log += 'LLAMADA: Initialize ('+parameter+')\n';}
...
//  Nombre del método: Terminate (parameter)
//  Descripción:

    API_1484_11.Terminate = function(parameter) 
    {
      if (this.debug) {alert("LLAMADA Terminate()"); API_1484_11.log += 'LLAMADA: Terminate ('+parameter+')\n'; alert(API_1484_11.log);}
...
//  Descripción:
    ...
    {
      if (this.debug) {alert('LLAMADA: GetValue ('+descriptor+')');}
      if (this.debug) {API_1484_11.log += 'LLAMADA: GetValue ('+descriptor+') \n';}
      if (this.state == 1) 
      {
...
//  Descripción:
    ...
    {
      if (this.debug) {alert('LLAMADA: SetValue ('+descriptor+', '+value+')');}
      if (this.debug) {API_1484_11.log += 'LLAMADA: SetValue ('+descriptor+', '+value+') \n';}
      if (this.state == 1) 
      {        
...
//  Nombre del método: Commit (parameter)
//  Descripción:

    API_1484_11.Commit = function(parameter) 
    {
      if (this.debug) {API_1484_11.log += 'LLAMADA: Commit () \n';}
      if (this.state == 1) 
      {
        this.lasterror = '0';
        return 'true';
...
//  Descripción:
    ...
    {
      if (this.debug) {API_1484_11.log += 'LLAMADA: GetLastError ()...'+this.lasterror+'\n';}
...
//  Nombre del método: GetErrorString (errornumber)
//  Descripción:
...
//  Nombre del método: GetDiagnostic (parameter)
//  Descripción:
