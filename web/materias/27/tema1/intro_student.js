...
function mm_adlOnload()
{
  ...
  contenido += mm_nombre;
  contenido += '</p>\n'+'</td>\n'+'</tr>\n'+'<tr>\n'+'<td>&nbsp;</td>\n'+'<td height="20"><img src="../shared/imagenes/biblio_p.jpg" alt="tema" width="20" height="25" hspace="2" align="absmiddle" />Te encuentras en la unidad de <strong>Introducci&oacute;n</strong></td>\n'+'</tr>\n'+'<tr>\n'+'<td>&nbsp;</td>\n'+'<td height="20"><img src="../shared/imagenes/lupa.jpg" alt="revisión" width="20" height="25" hspace="2" align="absmiddle" />Has revisado este tema <strong>';
